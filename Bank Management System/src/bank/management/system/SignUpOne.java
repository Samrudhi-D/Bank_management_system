...
public class SignUpOne extends JFrame implements ActionListener{//Inheritance
    long random;
    ...
    public void actionPerformed(ActionEvent et){
                 ...
                 try{
                    if(name.equals("")&&fname.equals("")&&dob.equals("")&&gender.equals("")&&email.equals("")&&status.equals("")&&pin.equals("")&&address.equals("")&&city.equals("")){
                         JOptionPane.showMessageDialog(null,"Please fill all the fields!!");
                    }
                    else{
                        Conn c=new Conn();
                        
                        String query="Insert into signup values('"+formno+"','"+name+"','"+fname+"','"+dob+"','"+gender+"','"+status+"','"+email+"','"+state+"','"+address+"','"+city+"','"+pin+"')";
