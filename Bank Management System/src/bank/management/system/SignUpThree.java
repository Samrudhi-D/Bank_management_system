...
public  class SignUpThree extends JFrame implements ActionListener {
    ...
    SignUpThree(String formno){
        ...
        JLabel pnnumber=new JLabel("XXXX-XXXX-XXXX-4184");
        pnnumber.setFont(new Font("Raleway",Font.BOLD,22));
        pnnumber.setBounds(330,370,300,30);
        add(pnnumber);
        ...
        c7=new JCheckBox("I hereby decclares that the above entered details are correct to the best of knowladge.");
    ...
    {    if(e.getSource().equals(submit)){
          ...
          if(r1.isSelected()){
               ...
               Saccount="Fixed Deposit Account";
          
          }else if(r3.isSelected()){
          
               Saccount="Current Account";
          }else if(r4.isSelected()){
              Saccount="Recurring Deposit Account";
          }
          ...
          try{
              ...
              Conn con=new Conn();
              String query1="Insert into signupthree values('"+formno+"','"+Saccount+"','"+cardnumber+"','"+pinnumber+"','"+facility+"')";
